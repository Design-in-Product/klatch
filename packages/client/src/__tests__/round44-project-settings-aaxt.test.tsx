 ...
 *   KB1: Knowledge base injection — "included in AI context for all channels" label semantics (copy updated from "L3 context" post-Daedalus merge)
...
const PROBES: ProjectSettingsProbe[] = [
  ...
  },
  {
    ...
    state: 'S-files',
    question: 'The "Knowledge base" section label reads "(2 files — included in AI context for all channels in this project)". What does "included in AI context" mean for how these files are used?',
    ...
    scopeNote: 'Copy updated from "L3 context" (domain jargon) to "AI context" (plain language) — probe now checks whether the plainer label successfully conveys cross-channel injection',
