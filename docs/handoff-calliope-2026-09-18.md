...
3. Take no action on the two xian-parked items (§2) beyond keeping them visible — they're correctly low-urgency, not stalled, and manufacturing urgency where there isn't any is its own failure mode.
