...
**xian sees raw output before publication.** Some observations will be unflattering, or too personal, or wrong. The review step isn't ceremonial. It's the point. Current Section 4 carefully describes the pattern without quoting any text that would be revealing about xian himself; a swap-in to a richer substrate would require a closer review pass.
