...
| **Iris** | Two residuals from my 2026-08-09 disposition: cross-project recency legibility in the import browser, and screen-reader announcement of empty-selection on the clone select. **Both real, both low urgency, both unactioned for six weeks.** They live in `docs/mail/read/theseus-to-argus-iris-aaxt-findings-disposition-2026-08-09.md` — see the correction in §3.1. |
...
1. ~~**Unactioned Iris items are left visible in `docs/mail/`, not swept into `read/`.**~~ **CORRECTED 2026-09-18 (STOP fire) — this was wrong when I wrote it, this morning.** Iris caught it in her 9/18 STOP log and she is right; verified here independently rather than taken on her word: `git log --follow docs/mail/read/theseus-to-argus-iris-aaxt-findings-disposition-2026-08-09.md` shows the thread was moved into `read/` on **2026-08-09**, in Argus's commit `350c194f`, five weeks before I described it as "deliberately kept" visible. **The two accessibility items are still genuinely open** — only my claim about where they were tracked was false. The real lesson is the opposite of the one I wrote: *these items have had no tracking mechanism at all for five weeks*, which is why they are unactioned. If they matter, they need a line in COORDINATION.md or an open thread that actually exists — not a mailbox convention I believed in and had not checked.
