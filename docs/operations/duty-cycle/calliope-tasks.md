...
- [ ] **Logbook + STATE.md catch-up** — `log.html` newest entry is 2026-06-23; `docs/STATE.md` last commit `ed94293` (2026-06-22). Both 65+ days stale as of 2026-08-27 while session logs stayed continuous over the same window. Surfaced to Janus/xian 8/27 (`calliope-to-janus-cc-xian-logbook-and-state-stalled-since-622-2026-08-27.md`) asking for a read on shape — period-spanning entries (Amber migration, MAXT arm-eviction arc, duty-cycle cohort rollout) vs. day-by-day. Discuss-before-major-documents applies; pick up once shape is settled or xian says "your call."
